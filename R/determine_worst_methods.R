...
coverage_probs_short_wc <- rbind(aurora_stats$short_cov_prob, black_ca_stats$short_cov_prob, black_wa_stats$short_cov_prob,
                                 ...
                                 cabezon_scs_stats$short_cov_prob, canary1_stats$short_cov_prob, chilipepper_stats$short_cov_prob,
                                 ...
                                 yelloweye1_stats$short_cov_prob)
...
coverage_probs_short_wc$stock_name <- c(rep("aurora", nrow(aurora_stats$short_cov_prob)),
                                        ...
                                        rep("canary", nrow(canary1_stats$short_cov_prob)),
                                        ...
                                        rep("yelloweye", nrow(yelloweye1_stats$short_cov_prob)))
...
coverage_probs_long_wc <- rbind(aurora_stats$long_cov_prob, black_ca_stats$long_cov_prob, black_wa_stats$long_cov_prob,
                                 ...
                                 cabezon_scs_stats$long_cov_prob, canary1_stats$long_cov_prob, chilipepper_stats$long_cov_prob,
                                 ...
                                 yelloweye1_stats$long_cov_prob)
...
coverage_probs_long_wc$stock_name <- c(rep("aurora", nrow(aurora_stats$long_cov_prob)),
                                        ...
                                        rep("canary", nrow(canary1_stats$long_cov_prob)),
                                        ...
                                        rep("yelloweye", nrow(yelloweye1_stats$long_cov_prob)))
